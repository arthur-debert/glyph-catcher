...
def test_export_with_compression():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        aliases_data = {"0041": ["A", "Capital A"]}

        # Export with compression
        options = ExportOptions(format_type="lua", output_dir=temp_dir, compress=True)
...
def test_export_without_compression():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        options = ExportOptions(format_type="lua", output_dir=temp_dir, compress=False)
