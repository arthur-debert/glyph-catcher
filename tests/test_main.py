...
from uniff_gen.cli import cli, generate, info
from uniff_gen.core import process_unicode_data
from uniff_gen.types import ExportOptions, FetchOptions
...
class TestMain(unittest.TestCase):
    ...
    def test_info_command(self):
        ...
        self.assertIn("uniff-gen: Unicode Data Format Information", result.output)
    ...
    @patch("uniff_gen.core.process_unicode_data")
    ...
    @patch("uniff_gen.core.fetch_all_data_files")
    @patch("uniff_gen.core.process_data_files")
    @patch("uniff_gen.core.export_data")
    @patch("uniff_gen.core.save_source_files")
    ...
    def test_cli_command_group(self):
        ...
        self.assertIn(
            "uniff-gen: Download and process Unicode character data.", result.output
        )
